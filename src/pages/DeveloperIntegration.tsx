...
const DeveloperIntegration: React.FC = () => {
  ...
  return (
    <div className="container py-10 max-w-6xl">
      <h1 className="text-3xl font-bold mb-6">Developer Integration</h1>
      ...
      <Tabs defaultValue="api-keys" className="w-full">
        <TabsList className="grid grid-cols-4 w-full mb-8">
          ...
          <TabsTrigger value="web-integration" className="flex items-center gap-2">
        ...
        <TabsContent value="web-integration" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-xl">Web Integration</CardTitle>
              <CardDescription>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" id="payment-authorized" className="rounded border-gray-300" checked />
                    <label htmlFor="payment-authorized" className="text-sm">Payment Authorized</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" id="payment-failed" className="rounded border-gray-300" checked />
                    <label htmlFor="payment-failed" className="text-sm">Payment Failed</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" id="payment-captured" className="rounded border-gray-300" checked />
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Unified Payments Interface</p>
                    </div>
                  </div>
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between">
