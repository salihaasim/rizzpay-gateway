...
const CodeExamples: React.FC<CodeExamplesProps> = ({ apiKey, webhookEndpoint }) => {
...
async function initiateRizzpayPayment(paymentDetails) {
  ...
  const urlCode = `${webhookEndpoint}?token=${apiKey}&amount=100.00&currency=INR&customer_name=John+Doe&customer_email=john@example.com&callback_url=https://yourwebsite.com/payment-callback`;
