...
const Layout: React.FC<LayoutProps> = memo(({ children, hideNavigation = false }) => {
  ...
  // Display responsive layout for authenticated merchants with light merchant styling
  return (
    <div className="min-h-screen flex bg-white transition-colors duration-200">
      {!hideNavigation && (
        <DashboardSidebar />
      )}
